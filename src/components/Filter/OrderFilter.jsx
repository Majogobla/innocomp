  ...
  return (
    <div className="flex flex-col xl:flex-row xl:gap-2 xl:items-center mt-6 w-full">
      ...
      <div className="flex flex-1 gap-1">
        <div className="px-1 border-gray-500 border  rounded-lg cursor-pointer" onClick={() => setAscDesc(!ascDesc)}>
          {ascDesc ? <div className="text-2xl text-center">&uarr;</div> : <div className="text-2xl text-center">&darr;</div>}
        </div>

        <select id="sort" className="w-full text-center text-xl py-1 shadow rounded-lg" onChange={e => setSort(e.target.value)}>
